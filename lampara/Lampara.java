...
public class Lampara {
	private boolean encendida;//encapsulaci\u00f3n de atributos. Inicialmente la l\u00e1mpara se encuentra apagada.

	void encender() {
		setEncendida(true);//acceso al campo encendida.
		System.out.println("Iluminando");									
	}

	void apagar() {
		setEncendida(false);//acceso al campo encendida.
